...
- `SearchBar`: Added keyboard action types @ccXxx1aoBai ([#366](https://github.com/Tencent/tdesign-flutter/pull/366))
...
- `DropdownMenu`: Added decorator configuration: `decoration`, which allows customizing menu color and border @hkaikai ([#408](https://github.com/Tencent/tdesign-flutter/pull/408))
...
- `Toast`: Supports customizing overlay background color @ccXxx1aoBai ([#423](https://github.com/Tencent/tdesign-flutter/pull/423))
...
- `SearchBar`: Added read-only property and click event @shizhe2018 ([#393](https://github.com/Tencent/tdesign-flutter/pull/393))
- `Dialog`: `TDDialogButtonOptions` added font size property @shizhe2018 ([#381](https://github.com/Tencent/tdesign-flutter/pull/381))
- `DateTimePicker`: Added time unit display property @shizhe2018 ([#383](https://github.com/Tencent/tdesign-flutter/pull/383))
...
## 🐞 Bug Fixes
- `NoticeBar`: Fixed web end text display abnormal issue @ccXxx1aoBai ([#351](https://github.com/Tencent/tdesign-flutter/pull/351))
- `Rate`: Fixed the issue where clicking the prompt box did not trigger the `onChange` event when half-selected @hkaikai ([#361](https://github.com/Tencent/tdesign-flutter/pull/361))
- `Calendar`: Fixed the issue of inaccurate echo scroll position due to inconsistent number of rows in month dates @hkaikai ([#363](https://github.com/Tencent/tdesign-flutter/pull/363))
- `Calendar`: Optimized the issue of rendering lag caused by too large `min`, `max` values @hkaikai ([#363](https://github.com/Tencent/tdesign-flutter/pull/363))
- `Input`: Fixed the issue where the divider line was not aligned with the content when setting `contentPadding` @epoll-j ([#365](https://github.com/Tencent/tdesign-flutter/pull/365))
- `Table`: Solved the issue of fixed column width overflow @ccXxx1aoBai ([#370](https://github.com/Tencent/tdesign-flutter/pull/370))
- `Popup`: Fixed the issue of delayed closing when clicking the overlay @hkaikai ([#380](https://github.com/Tencent/tdesign-flutter/pull/380))
- `Cascader`: Added first-level click selection function @shizhe2018 ([#355](https://github.com/Tencent/tdesign-flutter/pull/355))
- `DateTimePicker`: Added restriction on hours, minutes, and seconds @shizhe2018 ([#362](https://github.com/Tencent/tdesign-flutter/pull/362))
- `Textarea`: Optimized word limit change update @shizhe2018 ([#385](https://github.com/Tencent/tdesign-flutter/pull/385))
...
- `Picker`: Modified multi-layer dialog, sliding could not select color issue @shizhe2018 ([#413](https://github.com/Tencent/tdesign-flutter/pull/413))
- `SearchBar`: Fixed the issue of default position jitter when `SearchBar` gathered, and cursor not centered @Luozf12345 ([#417](https://github.com/Tencent/tdesign-flutter/pull/417))
...
- `TDBottomTabBar`: Fixed the issue of bottom overflow 2.5 pixels in `iconText` mode @epoll-j ([#422](https://github.com/Tencent/tdesign-flutter/pull/422))

## 🚧 Others
- Adapted to FlutterSdk3.25, minimum supported version adjusted to 3.16.0 @shizhe2018 ([#378](https://github.com/Tencent/tdesign-flutter/pull/378))
...
- Added component search function in demo @Luozf12345 ([#410](https://github.com/Tencent/tdesign-flutter/pull/410))
